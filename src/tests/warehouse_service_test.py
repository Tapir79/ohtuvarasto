...
class TestWarehouseService(unittest.TestCase):
    ...
    def test_create_warehouse(self):
        warehouse_id = self.service.create_warehouse("Test Warehouse", 100.0, 20.0)
    ...
    def test_create_multiple_warehouses(self):
        id1 = self.service.create_warehouse("Warehouse 1", 100.0)
        id2 = self.service.create_warehouse("Warehouse 2", 200.0)
    ...
    def test_list_warehouses(self):
        self.service.create_warehouse("Warehouse 1", 100.0)
        self.service.create_warehouse("Warehouse 2", 200.0)
    ...
    def test_update_warehouse_name(self):
        warehouse_id = self.service.create_warehouse("Old Name", 100.0)
    ...
    def test_update_warehouse_capacity(self):
        warehouse_id = self.service.create_warehouse("Test", 100.0, 50.0)
    ...
    def test_add_to_warehouse(self):
        warehouse_id = self.service.create_warehouse("Test", 100.0, 20.0)
    ...
    def test_remove_more_than_available(self):
        ...
        warehouse = self.service.get_warehouse(warehouse_id)
        self.assertAlmostEqual(warehouse['saldo'], 0.0)
    ...
    def test_warehouse_paljonko_mahtuu(self):
        warehouse_id = self.service.create_warehouse("Test", 100.0, 30.0)
        warehouse = self.service.get_warehouse(warehouse_id)
        
        self.assertAlmostEqual(warehouse['paljonko_mahtuu'], 70.0)
